...
export default {
    ...
    async mounted() {
        if (!this.usuario || !this.usuario.tenantId) {
            console.error("Error: Usuario no encontrado en localStorage o `tenantId` ausente.");
            return;
        }
        ...
        async subscribeToPush() {
            ...
            try {
                ...
                if (permission !== "granted") {
                    console.warn("Notificación no permitida.");
                    return;
                }
                ...
                console.error("❌ Error en la suscripción a Web Push:", error);
            }
        },
        getDeviceInfo() {
