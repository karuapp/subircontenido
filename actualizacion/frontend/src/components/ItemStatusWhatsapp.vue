    ...
    return {
      status: {
        ...
        TIMEOUT: {
          ...
          description: 'Intentos de conexión fallidos. Comprueba tu conexión a internet móvil.'
        },
        DISCONNECTED: {
          color: 'negative',
          icon: 'mdi-wifi-strength-1-alert',
          status: 'Desconectado',
          description: 'Comprueba si tu teléfono con WhatsApp tiene conexión a internet.'
        },
        qrcode: {
          color: 'positive',
        ...
        DESTROYED: {
          ...
          status: 'Inactivo',
          description: 'Necesario para iniciar la conexión con WhatsApp y escanear el código QR.'
        },
        CONFLICT: {
          color: 'warning',
          icon: 'mdi-equal',
          status: 'Conflicto',
          description: 'Se está utilizando WhatsApp Web.'
        },
        OPENING: {
          color: 'black',
          icon: 'mdi-connection',
          status: 'Conectando',
          description: 'Iniciando la conexión con WhatsApp.'
        },
        CONNECTED: {
          color: 'positive',
