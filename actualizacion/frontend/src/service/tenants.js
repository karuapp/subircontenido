...
export function AlterarTenantValidateContact (data) {
  return request({
    url: `/tenantsValidateContact/${data.id}`,
    method: 'put',
    data
  })
}

export function AlterarTenantHearHubApi (data) {
  return request({
    url: `/tenantsHearHubApi/${data.id}`,
    method: 'put',
    data
  })
}

export function AlterarTenantTicketsRain (data) {
  return request({
    url: `/tenantsTicketsRain/${data.id}`,
    method: 'put',
    data
  })
}
...
export function AlterarTenantEncryptionKey (data) {
  return request({
    url: `/tenantsEncryptionKey/${data.id}`,
    method: 'put',
    data
  })
}
...
export function AlterarTenantUazapiHost (data) {
  return request({
    url: `/tenantsUazapiHost/${data.id}`,
    method: 'put',
    data
  })
}

export function AlterarTenantZapiHost (data) {
  return request({
    url: `/tenantsZapiHost/${data.id}`,
    method: 'put',
    data
  })
}
...
export function AlterarTenantAllowedChannels (data) {
  return request({
    url: `/tenantsAllowedChannels/${data.id}`,
    method: 'put',
    data
  })
}
