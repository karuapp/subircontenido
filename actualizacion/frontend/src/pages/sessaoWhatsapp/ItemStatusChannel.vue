    ...
    <q-item>
      ...
      <q-item-section>
        ...
        <q-item-label v-if="['PAIRING', 'TIMEOUT'].includes(item.status)">
          ...
          <span class="row col"> Asegúrate de que tu teléfono esté conectado a internet y que WhatsApp esté funcionando. Ábrelo o haz clic en el botón “Desconectar” para obtener un nuevo código QR. </span> -->
        </q-item-label>
        <q-item-label v-if="item.status == 'OPENING'">
          ...
          <span class="row col"> Esto puede tardar un tiempo.... </span> -->
        </q-item-label>
