      ...
      <q-dialog v-model="isDomainModalOpen" persistent>
        <q-card>
          ...
          <q-card-actions align="right">
            ...
            <q-btn
              flat
              :label="$t('assinatura.saveButton') || 'Salvar'"
              color="positive"
              @click="saveDomains"
...
export default {
  ...
  methods: {
    ...
    formatarDataBR(dataISO) {
      if (!dataISO) return "Sin fecha definida";
        ...
        const licenseInfo = `
          <div style="text-align:left;min-width:260px;max-width:350px;line-height:1.7;background:${bgColor};border-radius:10px;padding:2px 0;">
            <div style="margin-bottom:8px;display:flex;align-items:center;gap:8px;">
              ...
              <span style='font-weight:600;color:${expiryColor};font-size:1.08em;'>Caducidad:</span>
            </div>
            ...
            <div style="margin-bottom:8px;display:flex;align-items:center;gap:8px;">
              ...
              <span style='font-weight:600;color:${labelColor};font-size:1.08em;'>Dominios:</span>
            </div>
