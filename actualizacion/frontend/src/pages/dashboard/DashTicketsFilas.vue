          ...
          <div :class="contentClass"
            ...
            <q-card bordered
              ...
              <q-item v-if="visao === 'F' || visao === 'FS'"
                class="text-bold"
                :class="{
                  'bg-negative text-white': definirNomeFila(item[0]) === 'Sin Departamento'
                }">
                <q-item-section avatar>
                  <q-avatar>
                ...
                <q-item-section>
                  ...
                  <q-item-label caption
                    :class="{
                      'text-white': definirNomeFila(item[0]) === 'Sin Departamento'
                    }">
                ...
                <q-btn @click="listarFilas"
                  v-if="definirNomeFila(item[0]).toLowerCase() === 'Sin Departamento'"
                  flat
                  color="primary"
                  class="bg-padrao btn-rounded">
                  <q-icon name="mdi-transfer" />
  ...
  methods: {
    ...
    async confirmarTransferenciaTicket () {
      if(this.usuarioSelecionado === null) {
        this.$notificarErro('¡Seleccione el usuario y la cola de destino para las solicitudes de servicio pendientes!')
        return;
      }
      try {
