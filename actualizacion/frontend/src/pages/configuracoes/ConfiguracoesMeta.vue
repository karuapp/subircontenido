            ...
            <div class="col-12" style="margin-top: 20px;">
              ...
              >
                <template v-slot:append>
                  ...
                  >
                    <q-tooltip>{{ $t('configuracoesWebchat.generateNewToken') || 'Generar nuevo token' }}</q-tooltip>
                  </q-btn>
                  <q-icon
  ...
  methods: {
    ...
    async gerarNovoMetaToken() {
      try {
        ...
        this.$q.notify({
          color: 'positive',
          message: this.$t('configuracaoMeta.tokenUpdated') || '¡Token actualizado correctamente!',
          icon: 'check'
        })
      } catch (error) {
        ...
        this.$q.notify({
          color: 'negative',
          message: this.$t('configuracaoMeta.tokenError') || 'Error al generar nuevo token',
          icon: 'error'
        })
      } finally {
