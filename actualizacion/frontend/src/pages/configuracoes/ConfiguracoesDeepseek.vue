<template>
  <div v-if="userProfile === 'admin'">
    <q-banner
      v-if="deepseekAllTickets === 'enabled'"
    ...
    >
      ...
      {{ $t('common.enableDeepseekAllBanner') }}
    </q-banner>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            @update:model-value="atualizarConfiguracao('deepseek')"
          />
        </q-item-section>
      </q-item>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @update:model-value="atualizarConfiguracao('deepseekAllTickets')"
          />
        </q-item-section>
      </q-item>
    </q-list>
