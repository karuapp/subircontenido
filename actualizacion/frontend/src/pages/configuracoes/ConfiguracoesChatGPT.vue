<template>
  <div v-if="userProfile === 'admin'">
    <q-banner
      v-if="chatgptAllTickets === 'enabled'"
    ...
    >
      ...
      {{ $t('common.enableChatgptAllBanner') }}
    </q-banner>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            @update:model-value="atualizarConfiguracao('chatgpt')"
          />
        </q-item-section>
      </q-item>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @update:model-value="atualizarConfiguracao('chatgptAllTickets')"
          />
        </q-item-section>
      </q-item>
    </q-list>
