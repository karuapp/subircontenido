<template>
  <div v-if="userProfile === 'admin'">
    ...
    >
      ...
      {{ $t('common.enableOllamaAllBanner') }}
    </q-banner>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            @update:model-value="atualizarConfiguracao('ollama')"
          />
        </q-item-section>
      </q-item>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @update:model-value="atualizarConfiguracao('ollamaAllTickets')"
          />
        </q-item-section>
      </q-item>
    </q-list>
