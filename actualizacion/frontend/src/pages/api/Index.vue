  ...
  <div v-if="userProfile === 'admin'">
    <q-card class="q-ma-md" style="border-radius: 8px;">
        ...
        <div class="text-h6">
          ...
          <div class="float-right q-gutter-xs">
            ...
            <q-btn 
              ...
              class="lt-sm"
              @click="download">
              <q-tooltip>{{ $t('api.postmanButton') }}</q-tooltip>
            </q-btn>
            <q-btn 
              color="primary"
              icon="add"
              ...
              class="lt-sm"
              @click="apiEdicao = {}; modalApi = true">
              <q-tooltip>{{ $t('api.addButton') }}</q-tooltip>
            </q-btn>
          </div>
        </div>
      </q-card-section>
      ...
      <q-card-section class="scroll"
        :style="`height: ${$q.screen.lt.sm ? 'calc(100vh - 150px)' : 'calc(100vh - 200px)'}`">
        <q-item v-for="api in apis"
          ...
          <q-item-section top>
            ...
            <q-item-label lines="4"
              ...
              <p class="text-weight-medium q-pr-md blur-effect">
                <span class="text-bold">{{ $t('api.url') }}:
                </span>
                <span class="text-caption text-grey-7 lt-sm">{{ montarUrlIntegração(api.id) }}</span>
                <span class="text-body2 gt-xs">{{ montarUrlIntegração(api.id) }}</span>
              </p>
            </q-item-label>
            <q-item-label style="word-break: break-all;">
              <p class="text-weight-medium q-pr-md blur-effect">
                ...
                <span class="text-caption text-grey-7 lt-sm">{{ api.token }}</span>
                <span class="text-body2 gt-xs">{{ api.token }}</span>
              </p>
            </q-item-label>
            ...
            <q-item-label caption>
              <p class="text-weight-medium">
                <span class="text-bold">WebHook Status Mensaje:</span> <span> {{ api.urlMessageStatus }} </span>
              </p>
            </q-item-label> -->
            <!-- <q-item-label style="word-break: break-all;">
            ...
            <!-- <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Envío de archivos multimedia por URL:</span> <span> {{ montarUrlIntegraçãoMidiaUrl(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "mediaUrl": "https://crm.com/wp-content/uploads/2022/07/icon100.png", "body": "Mensaje", "number": "destino", "externalKey": "externalKeydd211"  } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Configuración del departamento:</span> <span> {{ montarUrlIntegraçãoFila(api.id) }} </span>
              </p>
              <p>
            ...
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Recuperación de información del ticket:</span> <span> {{ montarUrlIntegraçãoTicket(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "number": "00123456789" } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Recuperación de información del ticket:</span> <span> {{ montarUrlIntegraçãoUrl(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "mediaUrl": "https://crm.com/wp-content/uploads/2022/07/icon100.png", "body": "El mensaje deseado", "number": "00123456789", "externalKey": "externalKeydd211" } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Recuperación de información del ticket:</span> <span> {{ montarUrlIntegraçãoVoice(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Exemplo de Carga (POST):</span> <span> { "audio": "https://crm.com/wp-content/uploads/2022/12/audio.ogg", "number": "00123456789", "externalKey": "externalKeydd211" } </span>
              </p>
            </q-item-label> -->
          </q-item-section>
        </q-item>
