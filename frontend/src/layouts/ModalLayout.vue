    ...
    <q-dialog v-model="show" persistent>
      ...
      <q-card>
        ...
        <q-tabs v-model="activeTab" class="text-teal" align="left" narrow-indicator>
          ...
          <q-tab name="uso" label="Condiciones de Uso" :class="{ 'active-tab': activeTab === 'uso', 'inactive-tab': activeTab !== 'uso' }"/>

          <q-tab name="servicio" label="Condiciones del Servicio" :class="{ 'active-tab': activeTab === 'servicio', 'inactive-tab': activeTab !== 'servicio' }"/>
        ...
        <q-card-actions align="center">
          ...
          <q-btn label="He leído y acepto los términos de uso y condiciones del servicio" @click="aceitar" color="primary" />
