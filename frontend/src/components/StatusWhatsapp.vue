<template>
  <div class="flex flex-inline q-gutter-sm">
    ...
    <!--
      ...
      >
        <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
          Es necesario leer el código QR al conectarse.
        </span>
        <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
          ...
          <span class="row col">
           2 - Haz clic en el botón azul "QR Code";
          </span>
          <span class="row col">
            3 - Escanea el código QR generado con la app de WhatsApp en tu teléfono y espera a que se establezca la conexión.
          </span>
        </q-tooltip>
      </q-icon>
      <q-icon
      ...
      >
        <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
         Revisa tu teléfono y tu conexión a internet. Se perdió la conexión. Intentando reconectarte a WhatsApp.
        </span>
        <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
          <span class="text-weight-medium"> Acción: </span>
          <span class="row col">
