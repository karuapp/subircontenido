    ...
    <!--
      ...
      >
        ...
        <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
          ...
          <span class="row col">
            1 - Intenta cerrar y volver a abrir WhatsApp en tu teléfono.;
          </span>
          <span class="row col">
            2 - Asegúrate de que tu teléfono esté conectado a internet y WhatsApp esté abierto.;
          </span>
          <span class="row col">
            3 - Recarga la página del sistema.;
          </span>
          <span class="row col">
            4 - Haz clic en el botón "Desconectar" para obtener un nuevo código QR.
          </span>
        </q-tooltip>
      </q-icon>
      <q-icon
      ...
      >
        <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
          Requiere escanear códigos QR para conectarse..
        </span>
        <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
          ...
          <span class="row col">
            3 - Escanea el código QR generado con la app de WhatsApp de tu teléfono y espera a que se establezca la conexión..
          </span>
        </q-tooltip>
      </q-icon>
      <q-icon
      ...
      >
        <span class="q-ml-md text-weight-medium text-center text-caption text-white ">
          Revisa tu teléfono y tu conexión a internet; se ha perdido la conexión. Intentando reconectarme a WhatsApp.
        </span>
        <q-tooltip content-class="bg-light-blue-1 text-black q-pa-sm shadow-4">
          <span class="text-weight-medium"> Acción: </span>
          <span class="row col">
          ...
          <span class="row col">
            2 - Asegúrate de que tu teléfono esté conectado a internet y que WhatsApp esté abierto.;
          </span>
        </q-tooltip>
      </q-icon>
      <q-space />
