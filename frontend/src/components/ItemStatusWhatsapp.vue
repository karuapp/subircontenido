    ...
    return {
      status: {
        ...
        TIMEOUT: {
          ...
          description: 'Intentos de conexión fallidos. Comprueba la conexión a internet de tu teléfono.'
        },
        DISCONNECTED: {
          color: 'negative',
          icon: 'mdi-wifi-strength-1-alert',
          status: 'Desconectado',
          description: 'Comprueba si el teléfono con WhatsApp tiene conexión a internet.'
        },
        qrcode: {
          color: 'positive',
        ...
        CONFLICT: {
          ...
          icon: 'mdi-equal',
          status: 'Conflicto',
          description: 'Se está usando WhatsApp Web.'
        },
        OPENING: {
          color: 'black',
          icon: 'mdi-connection',
