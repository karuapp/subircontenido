export default {
  ...
  configuracoesGerais: {
    labels: {
      ...
      ticketNulo: "Afficher les tickets sans utilisateur ni file d'attente assignés",
    ...
    captions: {
      ...
      ticketNulo: "Tous les utilisateurs verront les rendez-vous sans utilisateur ni file d'attente attribués.",
  ...
  signup: {
    ...
    planLabel: "Valeur : R${value} | Connexions : {connexions} | Utilisateurs : {users}"
  },
  atendimentoChat: {
  ...
  sessaoModalWhatsapp: {
    ...
    additionalSettings: {
      ...
      proxy: {
        useProxy: "Utiliser un proxy",
        proxyUrl: "URL du proxy (http://177.69.214.155:53281)",
        proxyUser: "Utilisateur proxy",
        proxyPass: "Mot de passe proxy"
      }
    },
  ...
  nodeForm: {
    ...
    warning6: "- Les interactions avec Typebot, ChatGPT et Bloquer le Chatbot doivent toujours être le dernier nœud de l’étape ; le chatbot interne est désactivé et le service continue avec l’intégration définie.",
