        ...
        <q-card-section>
          ...
          <div v-if="whatsapp.type === 'webmail'" class="q-mt-md">
            <fieldset class="q-pa-md" style="border: 1px solid #ccc; border-radius: 8px;">
              <legend class="q-px-sm" style="font-weight: bold; color: #1976d2;">Configuração IMAP (Recebimento de Emails)</legend>
              ...
              <div v-if="isGmailProvider" class="q-mb-md">
                <q-banner class="bg-blue-1 text-blue-9 q-mb-md">
                  ...
                  <strong>Gmail OAuth2:</strong> O Gmail exige autenticação OAuth2 para aplicações de terceiros.
                  <template v-slot:action>
                    <q-btn 
                      flat 
                      color="blue" 
                ...
                <div v-if="whatsapp.smtpConfig.oauth2?.access_token" class="q-mb-md">
                  <q-banner class="bg-green-1 text-green-9">
                    ...
                    <strong>OAuth2 Configurado:</strong> Autenticação OAuth2 ativa para Gmail.
                    <div class="q-mt-sm text-caption">
                      <strong>Status:</strong> Autenticado e funcionando
                    </div>
                  </q-banner>
                </div>
              </div>
              ...
              <c-input
                ...
                type="number"
                placeholder="Ex: 993"
                :rules="[val => !!val || 'Porta IMAP é obrigatória']"
              />
          ...
          <div class="row q-my-md">
            <div class="section primary-gradient col-12" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram'  || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.chatGptConfig.title') }}</div>
              <div class="col-12 " v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') ">
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " class="text-caption">{{ $t('sessaoModalWhatsapp.chatGptConfig.resetPrompt') }}</label>
              <q-btn round
                flat
                dense
                @click="limparGpts()"
                v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo'|| whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') "
                >
                <q-icon size="2em"
                  name="mdi-restore" />
                <q-tooltip>
              ...
              <label v-if="chatgptAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " class="text-caption">Ao usar o Assistente o Prompt será desconsiderado</label>
              <q-btn round
                flat
                dense
            ...
            <div class="section primary-gradient col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'  ) " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.typeConfig.title') }}</div>
              <div class="col-12" v-if="typebotAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat' ) " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.difyConfig.title') }}</div>
              <div class="col-12" v-if="difyAtivo === 'enabled' && (whatsapp.type === 'whatsapp'  || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.n8nConfig.title') }}</div>
              <div class="col-12" v-if="n8nAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') ">
            ...
            <div class="section primary-gradient col-12" v-if="ollamaAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="ollamaAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.ollamaConfig.title') }}</div>
              <div class="col-12" v-if="ollamaAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="lmAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="lmAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.lmConfig.title') }}</div>
              <div class="col-12" v-if="lmAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="grokAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="grokAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.grokConfig.title') }}</div>
              <div class="col-12" v-if="grokAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="geminiAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="geminiAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.geminiConfig.title') }}</div>
              <div class="col-12" v-if="geminiAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient col-12" v-if="deepseekAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="deepseekAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat' ) " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.deepseekConfig.title') }}</div>
              <div class="col-12" v-if="deepseekAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat' )">
            ...
            <div class="section primary-gradient col-12" v-if="qwenAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="qwenAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat' ) " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.qwenConfig.title') }}</div>
              <div class="col-12" v-if="qwenAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat' )">
            ...
            <div class="section primary-gradient col-12" v-if="claudeAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
              <div class="text-h8" v-if="claudeAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat') " style="margin-top: 20px;">{{ $t('sessaoModalWhatsapp.claudeConfig.title') }}</div>
              <div class="col-12" v-if="claudeAtivo === 'enabled' && (whatsapp.type === 'whatsapp' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'telegram' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat')">
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'">
            ...
            <div class="section primary-gradient" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'">
            <div >
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'waba' || whatsapp.type === 'baileys' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'">
                <q-item tag="label" v-ripple>
                  <q-item-section>
            ...
            <div>
              <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type === 'waba' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'">
                <q-item tag="label" v-ripple>
                  <q-item-section>
            ...
            <div class="col-12" v-if="whatsapp.type === 'whatsapp' || whatsapp.type === 'baileys' || whatsapp.type === 'waba' || whatsapp.type === 'meow' || whatsapp.type === 'evo' || whatsapp.type.includes('hub') || whatsapp.type === 'webchat'">
              <q-item tag="label" v-ripple>
                <q-item-section>
  ...
  methods: {
      ...
      this.$q.dialog({
        ...
        try {
          ...
          if (response.hasMore) {
            ...
            this.$q.notify({
              type: 'info',
              message: `Volume alto detectado: ${response.estimatedTotal} tickets. O processo continuará no servidor.`,
              position: 'top',
              timeout: 3000
            });
            ...
            const progressNotification = this.$q.notify({
              type: 'info',
              message: `Processando tickets... ${totalProcessed} processados`,
              position: 'top',
            ...
            this.$q.notify({
              type: 'positive',
              message: `${this.$t('sessaoModalWhatsapp.newChannelSuccess')} - ${totalProcessed} tickets processados`
            });
          } else {
      ...
      if (this.whatsAppEdit.id) {
        ...
        if (!this.whatsapp.smtpConfig.oauth2) {
          ...
          if (this.whatsapp.smtpConfig.oauth2.access_token === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'access_token', '');
          }
          if (this.whatsapp.smtpConfig.oauth2.refresh_token === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'refresh_token', '');
          }
          if (this.whatsapp.smtpConfig.oauth2.expires_in === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'expires_in', 0);
          }
          if (this.whatsapp.smtpConfig.oauth2.token_type === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'token_type', '');
          }
          if (this.whatsapp.smtpConfig.oauth2.scope === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'scope', '');
          }
          if (this.whatsapp.smtpConfig.oauth2.provider === undefined) {
            this.$set(this.whatsapp.smtpConfig.oauth2, 'provider', 'gmail');
          }
        }
    ...
    async configureGmailOAuth2Method() {
      try {
        ...
        if (!this.whatsapp.id) {
          throw new Error('WhatsApp ID não encontrado. Salve o WhatsApp primeiro.');
        }
        ...
        if (!this.whatsapp.smtpConfig.oauth2?.client_id || !this.whatsapp.smtpConfig.oauth2?.client_secret) {
          throw new Error('Configure o Client ID e Client Secret OAuth2 primeiro.');
        }
    ...
    async testSmtpConnectionMethod() {
      try {
        ...
        if (response.data.success) {
          ...
          this.$q.notify({
            type: 'negative',
            message: this.$t('sessaoModalWhatsapp.novo.falhaNoTesteSmtp') + (response.data.message || 'Erro desconhecido'),
            position: 'top'
          });
        }
      } catch (error) {
    ...
    async testImapConnectionMethod() {
      try {
        ...
        if (!this.whatsapp.id) {
          this.$q.notify({
            type: 'warning',
            message: 'Salve o WhatsApp primeiro para testar a conexão IMAP',
            position: 'top'
          });
          return;
        }
        ...
        if (response.data.success) {
          ...
          this.$q.notify({
            type: 'negative',
            message: 'Falha no teste IMAP: ' + (response.data.message || 'Erro desconhecido'),
            position: 'top'
          });
        }
      } catch (error) {
        ...
        this.$q.notify({
          type: 'negative',
          message: 'Erro ao testar IMAP: ' + (error.response?.data?.message || error.message),
          position: 'top'
        });
      } finally {
    ...
    async testPop3ConnectionMethod() {
      try {
        ...
        if (!this.whatsapp.id) {
          this.$q.notify({
            type: 'warning',
            message: 'Salve o WhatsApp primeiro para testar a conexão POP3',
            position: 'top'
          });
          return;
        }
        ...
        if (response.data.success) {
          this.$q.notify({
            type: 'positive',
            message: 'Conexão POP3 testada com sucesso!',
            position: 'top'
          });
        } else {
          this.$q.notify({
            type: 'negative',
            message: 'Falha no teste POP3: ' + (response.data.message || 'Erro desconhecido'),
            position: 'top'
          });
        }
      } catch (error) {
        ...
        this.$q.notify({
          type: 'negative',
          message: 'Erro ao testar POP3: ' + (error.response?.data?.message || error.message),
          position: 'top'
        });
      } finally {
