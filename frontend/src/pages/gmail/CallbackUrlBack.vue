  ...
  <div class="gmail-callback-page">
    <div class="callback-container">
      ...
      <div v-else-if="success" class="text-center">
        ...
        <div class="text-h5 text-positive q-mt-md">{{ $t('gmailCallback.title') || '✅ ¡Autorización de Gmail completa!' }}</div>
      ...
      <div v-else class="text-center">
        ...
        <div class="text-body1 q-mt-sm">
          {{ $t('gmailCallback.waitingMessage') || 'Esperando procesamiento de autorización...' }}
        </div>
      </div>
    </div>
  </div>
