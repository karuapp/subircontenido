      ...
      <q-card class="q-ma-md">
        <q-card-section>
          <q-item-label style="word-break: break-all;">
            ...
            <pre><b>{{ $t('tenantApi.routes.endpoint') }} #1: </b><a target="_blank" href="https://documenter.getpostman.com/view/48685409/2sB3QDwD7N#5828e47e-dceb-42f3-b7d2-0fe7c3a4c87c">{{ montarUrlIntegração() }}</a></pre>
            <pre><b>{{ $t('tenantApi.routes.endpoint') }} #2: </b><a target="_blank" href="https://documenter.getpostman.com/view/48685409/2sB3QDwD7N#1f10c2ae-1dad-4478-a5d5-2962df4e28cc">{{ montarUrlIntegraçãoStatus() }}</a></pre>
