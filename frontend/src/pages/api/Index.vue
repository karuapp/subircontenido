        ...
        <q-item v-for="api in apis"
          ...
          <q-item-section top>
            ...
            <!-- <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Envío de medios por URL:</span> <span> {{ montarUrlIntegraçãoMidiaUrl(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "mediaUrl": "https://crm.comr/wp-content/uploads/2022/07/icon100.png", "body": "mensaje", "number": "destino", "externalKey": "externalKeydd211"  } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Establecer departamento:</span> <span> {{ montarUrlIntegraçãoFila(api.id) }} </span>
              </p>
              <p>
            ...
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Buscar información sobre ticket:</span> <span> {{ montarUrlIntegraçãoTicket(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "number": "001191234567" } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Buscar información sobre ticket:</span> <span> {{ montarUrlIntegraçãoUrl(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "mediaUrl": "https://crm.com/wp-content/uploads/2022/07/icon100.png", "body": "Un Mensaje deseado", "number": "0015998566622", "externalKey": "externalKeydd211" } </span>
              </p>
            </q-item-label>
            <q-item-label class="item-label" caption>
              <p class="text-weight-medium">
                <span class="text-bold">Buscar información sobre el ticket:</span> <span> {{ montarUrlIntegraçãoVoice(api.id) }} </span>
              </p>
              <p>
                <span class="text-bold">Ejemplo de carga (POST):</span> <span> { "audio": "https://crm.com/wp-content/uploads/2022/12/audio.ogg", "number": "0015998566622", "externalKey": "externalKeydd211" } </span>
              </p>
            </q-item-label> -->
          </q-item-section>
        </q-item>
