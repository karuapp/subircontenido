<template>
  <div @drop.prevent="handleFileDrop" @dragover.prevent>
    <div class="drop-area" @drop="handleFileDrop" @dragover="handleDragOver" @dragleave="handleDragLeave">
           ...
           <div v-if="$q.screen.width > 500" class="desktop-view full-width row items-center">
            ...
            <div class="row items-center">
              ...
              <q-btn-dropdown v-if="!isScheduleDate || ticketFocado.channel === 'waba'" flat dense icon="mdi-dots-vertical" class="bg-padrao btn-rounded q-mx-xs" :color="$q.dark.isActive ? 'white' : ''">
                ...
                <q-item v-if="desabilitarInputWebchat && !isScheduleDate && ['whatsapp', 'baileys', 'meow', 'evo', 'waba', 'zapi', 'uazapi'].includes(ticketFocado.channel)" clickable v-close-popup @click="abrirDialogVcard" icon="mdi-card-account-phone" :disable="desabilitarInput">
                ...
                <q-item v-if="desabilitarInputWebchat && !isScheduleDate && ['whatsapp', 'baileys', 'meow', 'evo', 'zapi', 'uazapi'].includes(ticketFocado.channel)" clickable v-close-popup @click="abrirDialogLocation" icon="mdi-map-marker" :disable="desabilitarInput">
          ...
          <div v-else class="mobile-view full-width row items-center">
            ...
            <q-btn-dropdown v-if="!isScheduleDate || ticketFocado.channel === 'waba'" flat dense icon="mdi-dots-vertical" class="bg-padrao btn-rounded q-mx-xs" :color="$q.dark.isActive ? 'white' : ''">
              <q-list>
                ...
                <!-- Botão de Envio de Figurinha -->
                <q-item v-if="desabilitarInputWebchat && (ticketFocado.channel === 'whatsapp' || ticketFocado.channel === 'baileys' || ticketFocado.channel === 'meow' || ticketFocado.channel === 'evo' || ticketFocado.channel === 'zapi' || ticketFocado.channel === 'uazapi')" clickable v-close-popup @click="abrirEnvioSticker" icon="mdi-sticker-outline">
      ...
      <!-- Modal de envío de mensaje de etiqueta fantasma -->
      ...
      <!-- Modal de envío de mensaje de etiqueta de usuario -->
      ...
      <!-- Modal de envío de mensaje de botón -->
      ...
      <!-- Modal de envío de mensaje de lista -->
      ...
      <!-- Modal de envío de solicitud de ubicación -->
          ...
          <q-card-section class="q-pa-md">
            <div class="row q-col-gutter-md">
              <div :class="$q.screen.lt.sm ? 'col-12 q-mb-md' : 'col-6'">
                <div class="text-subtitle1" align="middle">Selección de Template</div>
                <q-select
      ...
      <!-- Modal de carga de archivos adjuntos -->
          ...
          <q-card-section>
            <div class="row q-col-gutter-md">
              ...
              <div class="col-12">
                ...
                <!-- Introducir el número de participante -->
                <div v-if="grupoOptions.promoverAdmin || grupoOptions.demoverAdmin || grupoOptions.adicionarParticipante || grupoOptions.removerParticipante" class="q-mt-md">
                  <q-input
                    ...
                    dense
                    outlined
                    hint="Separar los números con comas"
                  />
                </div>
              </div>
            </div>
      ...
      <!-- Modal de mensajes rápidos: se abre automáticamente con una tecla / -->
      <div 
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      gptEnabled: false,
      loading: false,
      accept: '.mkv, .ofx, .cdr, .key, .ai, .eps, .csv, .rar, .kml, .psd, .txt, .xml, .jpg, .png, .pdf, .doc, .docx, .mp4, .xls, .xlsx, .jpeg, .zip, .ppt, .ogg, .mp3, .pptx, image/*, .mpeg, .pfx, .p2k',
  ...
  methods: {
              ...
              component.buttons.forEach((button, index) => {
                if (button.type === 'URL' && button.url.includes('{{1}}')) { // Exemplo: botão de URL com variável
                      if (!this.selectedTemplateComponents.some(c => c.key === `button_url_${index + 1}`)) {
                          this.selectedTemplateComponents.push({
                              label: `Valor de la variable del botón URL. ${index + 1}`,
                              value: '',
    ...
    async enviarTemplateSelecionado() {
      ...
      try {
        ...
        console.log('socket ON: Template Éxito.:', response.data);
    ...
    limparCacheTemplateEspecifico(tokenApi) {
      ...
      console.log(`Caché de plantillas borrada para el token.: ${tokenApi}`)
    },
