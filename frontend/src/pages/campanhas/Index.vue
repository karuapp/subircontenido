...
<script>
import { CancelarCampanha, DeletarCampanha, IniciarCampanha, ListarCampanhas, DuplicarCampanha, RelatorioDetalhadoCampanha, AtualizarAckContatosCampanha } from 'src/service/campanhas.js'
    ...
    deletarCampanha (campanha) {
      ...
      this.$q.dialog({
        ...
        DeletarCampanha(campanha)
          ...
          .catch(err => {
            this.$notificarErro('Error al eliminar campaña', err)
          })
          .finally(() => {
            this.loading = false
          })
