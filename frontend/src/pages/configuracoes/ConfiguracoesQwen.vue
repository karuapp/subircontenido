      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            @update:model-value="atualizarConfiguracao('qwen')"
          />
        </q-item-section>
      </q-item>
      ...
      <q-item tag="label" v-ripple>
        ...
        <q-item-section avatar>
          <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @update:model-value="atualizarConfiguracao('qwenAllTickets')"
          />
        </q-item-section>
      </q-item>
    </q-list>
