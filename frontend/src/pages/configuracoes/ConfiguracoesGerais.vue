    ...
    <q-list class="text-weight-medium">
      ...
      <q-item-section avatar>
        <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @input="alterarTenantListByLastMessage('listarPelaUltimaMensagem')"
        />
        </q-item-section>
      </q-item>
      ...
      <q-item-section avatar>
        <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @input="alterarTenantControlFeatures('controleFeatures')"
        />
        </q-item-section>
      </q-item>
      ...
      <q-item-section avatar>
        <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @input="alterarTenantForcarRazao('forceReason')"
        />
        </q-item-section>
      </q-item>
      ...
      <q-item-section avatar>
        <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @input="alterarTenantAllowPause('allowPause')"
        />
        </q-item-section>
      </q-item>
      ...
      <q-item-section avatar>
        <q-toggle
            ...
            size="md"
            unchecked-icon="clear"
            @input="alterarTenantUseUserBusinessHours('useUserBusinessHours')"
        />
        </q-item-section>
      </q-item>
      ...
      <!-- <q-item tag="label" v-ripple class="responsive-item">
        ...
        <q-item-section avatar class="input-section">
          <q-input
            ...
            outlined
            debounce="700"
            @input="alterarTenantPostmanLink('postmanLink')"
          />
        </q-item-section>
      </q-item> -->
