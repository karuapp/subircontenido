...
export default {
    ...
    selectedTheme: {
      handler(newTheme) {
        ...
        if (!dashboardThemes[themeKey]) {
          console.warn(`Tema "${themeKey}" no encontrado, se usa el tema predeterminado`)
          themeKey = 'padrao'
  ...
  methods: {
    ...
    getDashTicketsChannels () {
      const statusMapping = {
        zapi: 'Z-API Nativo',
        uazapi: 'Uazapi Nativo',
        evo: 'WhatsApp Evolution Nativo',
        meow: 'WhatsApp Meow Nativo',
        whatsapp: 'WhatsApp Grupos QR Nativo',
        waba: 'WhatsApp Official Nativo',
        webmail: 'Webmail Nativo',
        hub_facebook: 'Facebook Hub',
        hub_instagram: 'Instagram Hub',
        hub_sms: 'SMS Hub',
        hub_telegram: 'Telegram Hub',
        hub_whatsapp: 'WhatsApp Hub',
        hub_whatsapp_business_account: 'WhatsApp Hub',
        hub_widget: 'Widget Hub',
        hub_webchat: 'WebChat Hub',
        hub_email: 'Email Hub',
        hub_mercadolivre: 'MercadoLibre Hub',
        hub_tiktok: 'TikTok Hub',
        hub_likedin: 'LinkedIn Hub',
        hub_olx: 'OLX Hub',
        hub_ifood: 'iFood Hub',
        hub_twitter: 'Twitter Hub',
        hub_youtube: 'YouTube Hub',
        telegram: 'Telegram',
        instagram: 'Instagram',
        baileys: 'WhatsApp Business QR',
        webchat: 'Webchat Nativo',
      };
