        ...
        <q-list class="text-weight-medium">
          <div class="row q-px-md">
            ...
            <!-- <div v-if="sending">
              ...
              <br>
              Por favor, espere mientras se envían los mensajes... No cierre esta página hasta que se complete el envío.
            </div> -->
...
export default {
  ...
  methods: {
    ...
    async buscarTemplateWaba() {
      ...
      console.log('Obteniendo plantillas de API')
      try {
    ...
    limparCacheTemplates() {
      ...
      console.log('Caché de plantilla borrada')
    },
    ...
    limparCacheTemplateEspecifico(tokenApi) {
      ...
      console.log(`Caché de plantilla borrada para token: ${tokenApi}`)
    },
    ...
    async enviarTemplateSelecionado() {
      ...
      for (const contato of contatos) {
        ...
        try {
          ...
          console.error(`Error al enviar a número ${contato.numero}:`, error);
        }
      }
